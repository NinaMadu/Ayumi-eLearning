  ...
  return (
    ...
    <div className="flex items-center justify-front min-h-screen bg-cover bg-center bg-no-repeat bg-opacity-90" style={{ backgroundImage: "url('/src/assets/bg1.jpg')",opacity:0.9 }} >
      ...
      <div class="mt-6 text-center">
        <span  class="text-sm text-blue-900 opacity-80">Already have an account?  <Link to='/Signin' class="font-medium text-blue-900 hover:text-blue-600 text-base">Login</Link></span>
      </div>
      </form>
      </div>     
    </div>
