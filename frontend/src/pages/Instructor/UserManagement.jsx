        ...
        <div className="bg-white rounded-lg shadow-lg">
          {users.map((user) => (
            ...
            >
              ...
              {/* Email Column */}
              <div>
                <h3 className="text-xs sm:text-sm md:text-base font-semibold">{user.email}</h3>
              </div>

              <div className=" gap-4 flex text-white font-semibold ">
                <button className=" border-spacing-4 bg-red-600 p-2 rounded-lg hover:bg-red-400">Delete</button>
                <button className=" border-spacing-4 bg-red-600 p-2 rounded-lg hover:bg-red-400">Deactivate</button>
              <div>
                <FaCircle
                  className={`text-sm font-semibold px-3 py-3 rounded-full ${
                    user.isLoggedIn
