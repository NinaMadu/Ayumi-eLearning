  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        <div className="bg-gradient-to-r from-red-600 via-red-300 to-red-600 text-black p-4 rounded-lg shadow-md h-40">
          <div className="flex flex-col items-center justify-center h-full">
            <FaUsers className="mb-2 text-4xl sm:text-5xl" />
        ...
        <div className="bg-gradient-to-r from-red-600 via-red-300 to-red-600 text-black p-4 rounded-lg shadow-md h-40">
          <div className="flex flex-col items-center justify-center h-full">
            <FaBook className="mb-2 text-4xl sm:text-5xl" />
            <div className="text-xl sm:text-2xl font-semibold">Total Courses</div>
            <div className="text-xl sm:text-2xl font-bold">20</div>
          </div>
        </div>
        <div className="bg-gradient-to-r from-red-600 via-red-300 to-red-600 text-black p-4 rounded-lg shadow-md h-40">
          <div className="flex flex-col items-center justify-center h-full">
            <FaUserPlus className="mb-2 text-4xl sm:text-5xl" />
            <div className="text-xl sm:text-2xl font-semibold">New Enrollments</div>
            <div className="text-xl sm:text-2xl font-bold">20</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <div className="text-lg font-semibold mb-4">Payment Distribution</div>
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie
                data={pieData}
        ...
        {/* Course Completion */}
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <div className="text-lg font-semibold mb-4">Course Completion Rates</div>
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={data}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" />
