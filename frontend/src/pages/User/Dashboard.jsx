      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            {[
              { icon: <FaBook />, label: 'Courses In Progress', value: 10, bg: 'bg-blue-100', textColor: 'text-blue-600', borderColors: ['border-blue-500', 'border-blue-300'] },
              { icon: <FaCheckCircle />, label: 'Courses Completed', value: 10, bg: 'bg-green-100', textColor: 'text-green-600', borderColors: ['border-green-500', 'border-green-300'] },
              { icon: <FaCertificate />, label: 'Certificates Earned', value: 10, bg: 'bg-yellow-100', textColor: 'text-yellow-600', borderColors: ['border-yellow-500', 'border-yellow-300'] },
            ].map((stat, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className={`text-3xl ${stat.textColor} mb-2`}>{stat.icon}</div>
          ...
          <div className="bg-gray-100 p-6 rounded-xl shadow-lg mb-8">
            ...
            <ResponsiveContainer
              width="100%"
              height={window.innerWidth < 640 ? 200 : 300} // Adjust height for small screens
            >
              <LineChart data={activityData}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="activity" stroke="#4A90E2" activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
